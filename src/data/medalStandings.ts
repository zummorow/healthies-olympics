...
export const medalStandings: MedalStanding[] = [
  ...
  { id: 3, name: 'Direktorat Jenderal Kesehatan Primer Komunitas', gold: 1, silver: 1, bronze: 2 },
  { id: 4, name: 'Direktorat Jenderal Kesehatan Lanjutan', gold: 1, silver: 2, bronze: 0 },
  { id: 5, name: 'Direktorat Jenderal Penanggulangan Penyakit', gold: 2, silver: 1, bronze: 1 },
