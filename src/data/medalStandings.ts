...
export const medalStandings: MedalStanding[] = [
  ...
  { id: 3, name: 'Direktorat Jenderal Kesehatan Primer Komunitas', gold: 3, silver: 2, bronze: 2 },
  { id: 4, name: 'Direktorat Jenderal Kesehatan Lanjutan', gold: 1, silver: 3, bronze: 1 },
  { id: 5, name: 'Direktorat Jenderal Penanggulangan Penyakit', gold: 4, silver: 1, bronze: 3 },
