...
const sportsCategories = [
  ...
  { name: 'Mini Soccer', slug: 'futsal', discipline: '05', icon: futsalIcon, color: 'border-primary-fixed', text: 'text-primary-fixed', bg: 'bg-primary-fixed', description: 'Turnamen futsal 5v5 antar unit kerja Kemenkes.' },
