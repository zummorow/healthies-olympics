...
const sportsCategories = [
  ...
  { name: 'Playstation Cup', slug: 'playstation-cup', discipline: '11', icon: pesIcon, color: 'border-primary-fixed', text: 'text-primary-fixed', bg: 'bg-primary-fixed', description: 'Turnamen e-sports PES antar unit utama.' },
